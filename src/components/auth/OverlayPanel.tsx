    ...
    >
      ...
      <div className="transition-opacity duration-500 max-w-md">
        ...
        <button
          ...
          className="mt-8 rounded-lg border border-border/50 px-10 py-3.5 text-sm font-semibold bg-primary/20 hover:bg-secondary hover:text-slate-900 transition cursor-pointer"
        >
          {authMode === "signin" ? (
            <>
